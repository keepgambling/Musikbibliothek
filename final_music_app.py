...
def manage_songs(library):
    while True:
        ...
        print("3. Zufällige Songs erstellen")
        ...
        if title_choice == '1':
            ...
            album = input("Gib das Album des Songs ein: ")
...
def search_songs(library):
    while True:
        print("\nTitel suchen")
        print("1. Linearer Suchalgorithmus")
        print("2. Binärer Suchalgorithmus")
        print("3. Zurück")
        search_choice = input("Wähle eine Option: ")
        if search_choice == '1':
            title = input("Gib den Titel des Songs ein: ")
            library.search_song()  # Linear search
        elif search_choice == '2':
            title = input("Gib den Titel des Songs ein: ")
            library.search_song()  # Binary search
...
def sort_songs(library):
    while True:
        ...
        print("4. Quick Sort")
        print("5. Zurück")
        sort_choice = input("Wähle eine Option: ")
        if sort_choice in ['1', '2', '3', '4']:
            library.sort_songs()  # Choose sort algorithm
        elif sort_choice == '5':
            break
        else:
            print("Ungültige Option.")
